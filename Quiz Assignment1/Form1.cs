    ...
    public partial class Form1 : Form
    {
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                dataGridView1.Rows[n].Cells[1].Value = textBoxExpenses.Text;
                dataGridView1.Rows[n].Cells[2].Value = textBoxSumIn.Text;
        ...
        private void bottonAdd_Click(object sender, EventArgs e)
        {
            ...
            textBoxSumIn.Text = sumin.ToString();
            textBoxSumEx.Text = sumex.ToString();
        }
